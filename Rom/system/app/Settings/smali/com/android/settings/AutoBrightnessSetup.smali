.class public Lcom/android/settings/AutoBrightnessSetup;
...
.method static synthetic access$000(Lcom/android/settings/AutoBrightnessSetup;Landroid/os/Bundle;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 34
    invoke-direct {p0, p1}, Lcom/android/settings/AutoBrightnessSetup;->showCustomizeDialog(Landroid/os/Bundle;)V
...
.method private showCustomizeDialog(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 175
    iget-object v0, p0, Lcom/android/settings/AutoBrightnessSetup;->mCustomizeDialog:Lcom/android/settings/AutoBrightnessCustomizeDialog;
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/AutoBrightnessCustomizeDialog;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/AutoBrightnessSetup;->mCustomizeDialog:Lcom/android/settings/AutoBrightnessCustomizeDialog;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 153
    :cond_0
    invoke-virtual {p0}, Lcom/android/settings/AutoBrightnessSetup;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    .line 154
    .local v1, resolver:Landroid/content/ContentResolver;
    iget-object v5, p0, Lcom/android/settings/AutoBrightnessSetup;->mSensitivity:Landroid/widget/Spinner;
    ...
    .line 156
    invoke-virtual {p0}, Lcom/android/settings/AutoBrightnessSetup;->getResources()Landroid/content/res/Resources;
    ...
    :cond_1
    iget-object v5, p0, Lcom/android/settings/AutoBrightnessSetup;->mAdjustment:Landroid/widget/SeekBar;
    ...
    iget-object v6, p0, Lcom/android/settings/AutoBrightnessSetup;->mAdjustment:Landroid/widget/SeekBar;
    ...
    iget-object v5, p0, Lcom/android/settings/AutoBrightnessSetup;->mTwilightAdjustment:Landroid/widget/CheckBox;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 51
    invoke-virtual {p0}, Lcom/android/settings/AutoBrightnessSetup;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    iget-object v2, p0, Lcom/android/settings/AutoBrightnessSetup;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/AutoBrightnessSetup;->getString(I)Ljava/lang/String;
    ...
    .line 63
    invoke-virtual {p0}, Lcom/android/settings/AutoBrightnessSetup;->setupAlert()V
    ...
    iput-object v4, p0, Lcom/android/settings/AutoBrightnessSetup;->mTwilightAdjustment:Landroid/widget/CheckBox;
    ...
    iput-object v4, p0, Lcom/android/settings/AutoBrightnessSetup;->mSensitivity:Landroid/widget/Spinner;
    ...
    iput-object v4, p0, Lcom/android/settings/AutoBrightnessSetup;->mAdjustment:Landroid/widget/SeekBar;
    ...
    .line 73
    iget-object v4, p0, Lcom/android/settings/AutoBrightnessSetup;->mSensitivity:Landroid/widget/Spinner;

    invoke-virtual {v4, v0}, Landroid/widget/Spinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    .line 75
    iget-object v4, p0, Lcom/android/settings/AutoBrightnessSetup;->mAlert:Lcom/android/internal/app/AlertController;
    ...
    new-instance v4, Lcom/android/settings/AutoBrightnessSetup$1;

    invoke-direct {v4, p0}, Lcom/android/settings/AutoBrightnessSetup$1;-><init>(Lcom/android/settings/AutoBrightnessSetup;)V
...
.method protected onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/AutoBrightnessSetup;->showCustomizeDialog(Landroid/os/Bundle;)V

    .line 142
    .end local v0           #dialogState:Landroid/os/Bundle;
    :cond_0
    iget-object v1, p0, Lcom/android/settings/AutoBrightnessSetup;->mSensitivity:Landroid/widget/Spinner;
    ...
    .line 143
    iget-object v1, p0, Lcom/android/settings/AutoBrightnessSetup;->mAdjustment:Landroid/widget/SeekBar;
    ...
    .line 144
    iget-object v1, p0, Lcom/android/settings/AutoBrightnessSetup;->mTwilightAdjustment:Landroid/widget/CheckBox;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 124
    iget-object v1, p0, Lcom/android/settings/AutoBrightnessSetup;->mCustomizeDialog:Lcom/android/settings/AutoBrightnessCustomizeDialog;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/settings/AutoBrightnessSetup;->mCustomizeDialog:Lcom/android/settings/AutoBrightnessCustomizeDialog;

    invoke-virtual {v1}, Lcom/android/settings/AutoBrightnessCustomizeDialog;->isShowing()Z
    ...
    iget-object v2, p0, Lcom/android/settings/AutoBrightnessSetup;->mCustomizeDialog:Lcom/android/settings/AutoBrightnessCustomizeDialog;
    ...
    iget-object v2, p0, Lcom/android/settings/AutoBrightnessSetup;->mSensitivity:Landroid/widget/Spinner;
    ...
    iget-object v2, p0, Lcom/android/settings/AutoBrightnessSetup;->mAdjustment:Landroid/widget/SeekBar;
    ...
    iget-object v2, p0, Lcom/android/settings/AutoBrightnessSetup;->mTwilightAdjustment:Landroid/widget/CheckBox;
...
.method protected onStart()V
    ...
    .line 105
    iget-object v7, p0, Lcom/android/settings/AutoBrightnessSetup;->mSensitivity:Landroid/widget/Spinner;
    ...
    .line 114
    iget-object v7, p0, Lcom/android/settings/AutoBrightnessSetup;->mAdjustment:Landroid/widget/SeekBar;

    add-float v8, v0, v9

    iget-object v9, p0, Lcom/android/settings/AutoBrightnessSetup;->mAdjustment:Landroid/widget/SeekBar;
    ...
    .line 116
    iget-object v7, p0, Lcom/android/settings/AutoBrightnessSetup;->mTwilightAdjustment:Landroid/widget/CheckBox;
